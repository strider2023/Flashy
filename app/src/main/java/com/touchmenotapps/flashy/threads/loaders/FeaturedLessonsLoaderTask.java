 ...
 */
public class FeaturedLessonsLoaderTask extends AsyncTaskLoader<List<LessonsDAO>> {

    private NetworkUtils networkUtils;
    private Map<String, Object> params = new HashMap<>();
    private List<LessonsDAO> lessonsDAOs = new ArrayList<>();

    public FeaturedLessonsLoaderTask(Context context, Map<String, Object> params) {
        super(context);
